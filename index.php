          ...
          <div class="mask" style="background-color: rgba();">
            <div class="d-flex justify-content-center align-items-center h-100">
             ...
             <marquee class="nn"  behavior="" direction="">  <p class="mb-4">Un pays de plusieurs diversitées. Le Burkina Faso une destination a ne pas manquer. <br></p></marquee> 
                <marquee class="nn" behavior="" direction="right" style="margin-bottom:3%;">Découvrez les merveilles cachées du Burkina Faso. Du parc national des Deux Balés à la ville mystique de Tiébélé, il y a tant à voir et à explorer.</marquee>
                <a
                  class="btn btn-outline-light btn-lg m-2"
                  href="inscription.php"
                  role="button"
                  rel="nofollow"
                style="background: green; color: white; margin-top: 5%; border:none;">Inscriver-vous</a
                >
                <a
                  class="btn btn-outline-light btn-lg m-2"
                  href="connexion_page.php"
                  role="button"
                  style="background: red; color: white; margin-top: 5%; border:none;">Se connecté</a
                >
              </div>
            </div>
          </div>
