...
<header style="background-image: url(le-burkina-faso-region-hauts-bassins-bobo-dioulasso-la-gare-ferroviaire-p2pf9m.jpg);">
        ...
        <div class="container-fluid">
          ...
          > <img class="i1" src="images/Flag_of_Burkina_Faso.svg.png" alt="">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="waga.php" style="color: antiquewhite;">A propos</a>
              </li>
...
<div>
<h1>Bienvenue à Bobo-Dioulasso la ville de Sya</h1>

<p style="color: black; font-weight: bold;">Découvrer les sites touristiques incontournable de Bobo-Dioulasso, la deuxième grande ville du Burkina Faso.
